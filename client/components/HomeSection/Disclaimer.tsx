...
const Disclaimer = () => {
  return (
    <div
      className='bg-cheese w-full bg-disclaimer h-full bg-bottom-right-4 bg-no-repeat rounded-lg py-12 px-12 mb-32'
      style={{ backgroundSize: '20%' }}
    >
      <h4 className='font-bold text-disclaimer text-4xl'>Peringatan</h4>
      <p className='w-8/12 text-xl text-disclaimer mt-12'>
